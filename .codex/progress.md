...
Latest small packet strengthened WPF smoke coverage for compact Quarantine Readiness Summary key-blocker labels on preview-only custom, exact real-profile, and real-profile-child scopes. The visible app behavior did not change; WPF app tests passed without scanning or modifying real user files.
