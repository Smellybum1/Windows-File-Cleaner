...
Latest small packet extends WPF smoke coverage for the compact Quarantine Readiness Summary so synthetic real-profile-child preview-only scopes also prove `movement unavailable` wording, warning styling, and mirrored tooltip/help text while execution stays blocked.
