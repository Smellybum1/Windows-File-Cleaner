...
Latest small packet added a compact Restore Manifest review summary in WPF. It summarizes discovery, selected-manifest readiness, all-manifest readiness, selected restore gate, and selected restore result state with neutral/information/success/warning styling and read-only/no-restore tooltip/help text, without changing restore or Quarantine execution availability.
