...
Latest small packet aligns the fixture checklist and README manual review wording with the compact Quarantine Readiness Summary preview-only `movement unavailable` wording. The checklist now asks manual reviewers to verify that wording near the Quarantine controls.
