...
Latest small packet added a visible hoverable `?` help cue beside the WPF Non-D Quarantine Root Acknowledgement, mirrored the checkbox tooltip/help text onto the cue, expanded WPF smoke affordance coverage to nineteen circular help cues, and updated the fixture checklist/docs. No scan, Quarantine execution, restore, deletion, folder creation, manifest writing, or cleanup history behavior changed.
