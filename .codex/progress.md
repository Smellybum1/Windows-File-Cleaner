...
Latest small packet aligned the manual fixture checklist with ADR 0018 first-phase blocker visibility. Checklist step 10 now asks reviewers to keep the 10-row cap, 1 GB cap, no-category rows, and strict descendant checks visible alongside ADR 0017/0019 blockers and read-only Real-Profile Quarantine Approval Evidence. Checklist-only output and whitespace diff passed without preflight, fixture creation, WPF launch, scan, or file modification.
