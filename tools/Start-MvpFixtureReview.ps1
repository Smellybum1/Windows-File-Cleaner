...
function Write-FixtureReviewChecklist {
    ...
    Write-Host "  3. Check the quieter panel layout: Safety Summary should start collapsed with the Safety Summary panel-name prefix plus hoverable ? header help cue, then expand cleanly; check Review Mix, Matched Review Mix, and Review Shortlist Safety Mix hoverable ? help cues plus prompt tooltip/help text, header state styling, state-naming tooltip/help text, review navigation/export tooltips, and Review Shortlist labels/tooltips."
