...
function Write-FixtureReviewChecklist {
    ...
    Write-Host "  8. Use Discover manifests, selected manifest readiness/gate, and all-manifest readiness preview; check no all-manifest restore action plus readiness scope tooltips, selected restore Approval boundary, Execution scope status, Selected Restore Execution Gate ? help cue in waiting/closed/open/restored states without crowding the gate area, and restore tooltips."
