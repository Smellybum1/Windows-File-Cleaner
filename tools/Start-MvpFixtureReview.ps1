...
function Write-FixtureReviewChecklist {
    ...
    Write-Host "  6. Shortlist the fixture cleanup candidate, create Quarantine Preview, and check preview/export tooltips, Approval boundary, Execution scope status, and execution tooltips."
