...
function Write-FixtureReviewChecklist {
    ...
    Write-Host "  8. Use Discover manifests, selected manifest readiness/gate, and restore-readiness preview; check no all-manifest restore action plus selected restore Approval boundary, Execution scope status, and restore tooltips."
