...
function Write-FixtureReviewChecklist {
    ...
    Write-Host "  3. Check Review Mix, Matched Review Mix, collapsible Safety Summary header/details plus header state styling and tooltip/help text, Review Shortlist Safety Mix, review navigation/export tooltips, and Review Shortlist labels/tooltips."
    ...
    Write-Host "  6. Shortlist fixture cleanup candidates, check the collapsible Quarantine shortlist header/details plus header state styling and tooltip/help text, Quarantine Root browse tooltip, styled inline preview readiness (neutral/success/warning/error) plus its tooltip/help text, preview/export tooltips, Approval boundary, Execution scope status, and execution tooltips."
    Write-Host "  7. For fixture only, type QUARANTINE, execute quarantine, use Current quarantined / Back to scan rows plus styled Review Grid Mode Status (neutral/informational/warning) and its tooltip/help text, then Undo fixture quarantine and rescan before more review."
