...
function Write-FixtureReviewChecklist {
    ...
    Write-Host "  3. Check the compact header Review Shortlist totals sit to the left of Total size when space allows, compact scan totals remain readable, and the horizontal tabbed workbench: Main Grid should be selected by default, Safety Summary / Review / Quarantine / Main Grid tabs should each have their own page, Safety Summary shortcuts should auto-focus Main Grid after applying their read-only review lens, Safety Summary should start expanded with the Safety Summary panel-name prefix plus hoverable ? header help cue, and Review Mix, Matched Review Mix, and Review Shortlist Safety Mix hoverable ? help cues plus prompt tooltip/help text, header state styling, state-naming tooltip/help text, review navigation/export tooltips, and Review Shortlist labels/tooltips should stay readable."
