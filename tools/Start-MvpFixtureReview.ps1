...
function Write-FixtureReviewChecklist {
    ...
    Write-Host "  3. Check Review Mix, Matched Review Mix, collapsible Safety Summary header/details plus header tooltip/help text, Review Shortlist Safety Mix, review navigation/export tooltips, and Review Shortlist labels/tooltips."
