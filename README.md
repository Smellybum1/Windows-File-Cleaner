...
12. For fixture scopes, optionally type `QUARANTINE` once, run `Quarantine included shortlist` for all included Review Shortlist rows, then use `Undo fixture quarantine` before or after a rescan to prove the reversible visible workflow.
