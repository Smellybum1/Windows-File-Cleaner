...
- The WPF work surface uses horizontal tabs for Scan, Safety Summary, Review, Quarantine, and Main Grid so the dense review and readiness sections each have their own page while the Cleanup Scope and scan-gate header stays visible.
...
6. Open the Scan tab and review the summary cards for total size, folders, files, and access issues.
