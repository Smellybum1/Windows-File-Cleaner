...
- Fixture tests include source-level guards against accidental cleanup-execution filesystem calls, read-only readiness builders calling movement executors or manifest writers, and WPF movement executor calls drifting outside the known gated execution bridge methods.
