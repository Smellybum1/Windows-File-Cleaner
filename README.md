...
17. For real-profile scopes, confirm `Quarantine included shortlist` and broad Undo stay unavailable, with ADR 0017 readiness-contract blockers visible before any real-profile cleanup execution.
