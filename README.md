...
- Quarantine Preview is a dry run only, and its semantically styled inline status plus mirrored tooltip/help text and preview/gate panes keep Review Shortlist and Quarantine Preview separate from cleanup approval.
