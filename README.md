...
Before launching, the script prints a compact fixture review checklist with the main safety, search, shortlist, preview approval-boundary, fixture execution, undo, manifest-review, and selected-restore scope-status checks.
