...
- Core Real-Profile Quarantine Approval Evidence records that exact `QUARANTINE` is necessary but not sufficient; current-build real-profile movement availability still defaults to unavailable and the model remains read-only.
