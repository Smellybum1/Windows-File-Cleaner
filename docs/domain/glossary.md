...
| Review Mix | Summary of result counts and largest rows by rating/recommendation. | `StorageReviewSummary` | Do not sum flattened recursive row sizes because parent and child rows overlap. |
