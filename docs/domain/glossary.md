...
| Protected Location | A path or category treated as high-risk or blocked from cleanup. | `ProtectedLocation`, `protectedLocationPath` | Includes profile essentials, sensitive app/user data, game data, and mod-manager data until exceptions are defined. |
