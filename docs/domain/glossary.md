...
| Storage Scan Safety Summary | Read-only health readout for safety-relevant scan signals. | `StorageScanSafetySummary`, `StorageScanSafetySummaryBuilder` | Not a safety guarantee, cleanup approval, or Cleanup Action. |
