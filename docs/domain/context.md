...
- It may focus the displayed list by exact Cleanup Scope, manifests that need recovery review, or manifests that still have undo work, or fail a terminal check when recovery-review or undo-work states remain, but that remains evidence only.
