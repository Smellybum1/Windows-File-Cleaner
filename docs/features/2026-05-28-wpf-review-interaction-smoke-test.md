...
- Added WPF fixture interaction coverage for filters, No category, protected shortcut, shortlist add/remove, Quarantine Preview, Restore Manifest Draft text, Quarantine Confirmation Draft text, disabled execution wording, protected-descendant preview blockers, separated readiness/row preview wording, and fixture file preservation.
