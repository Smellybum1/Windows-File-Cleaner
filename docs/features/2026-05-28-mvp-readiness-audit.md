...
| Quarantine on `D:` with undo path explored safely | Quarantine Preview, Restore Manifest Draft, Quarantine Confirmation Draft, Quarantine Action Draft, Restore Manifest File Store, Quarantine Executor, Undo Quarantine Executor, ADR 0003-0009 | Fixture and fixture-WPF verified | The app proves destination/readiness shape in WPF, core tests prove manifest writes plus fixture file moves and fixture undo, and WPF tests prove fixture-only visible execution without enabling real-profile execution. |
