...
| Undo Quarantine execution | ADR 0008, ADR 0010, Restore Manifest docs, core fixture tests, WPF fixture tests | Current fixture verified, broad WPF undo out of MVP | Core Undo Quarantine can restore fixture Moved entries, and WPF can undo the current fixture execution. Manifest discovery/history and real-profile WPF undo remain future work. |
