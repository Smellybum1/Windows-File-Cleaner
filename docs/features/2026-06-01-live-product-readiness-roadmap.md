...
- Manually trust selected restore for the created first-live Restore Manifest only after explicit user approval for that specific selected Restore Manifest.
