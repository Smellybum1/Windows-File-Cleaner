...
- Run `.\tools\Summarize-FixtureAcceptanceNotes.cmd` after the visible fixture pass to review open notes items.
- Run `.\tools\Summarize-FixtureAcceptanceNotes.cmd -RequireComplete` after filling notes when you want a non-zero completion check before copying results into progress docs.
