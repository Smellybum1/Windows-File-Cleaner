...
- Later packets expanded the tracked cue list to nineteen by adding Quarantine Execution Gate, Selected Restore Execution Gate, shortlist confirmation, Quarantine Manifest Discovery, Restore Manifest selection, all-manifest readiness, selected restore confirmation, and Non-D Quarantine Root Acknowledgement cues.
