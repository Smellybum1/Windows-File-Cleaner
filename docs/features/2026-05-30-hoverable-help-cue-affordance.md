...
- Later packets added the Quarantine Execution Gate, Selected Restore Execution Gate, shortlist confirmation, and selected restore confirmation cues; the WPF smoke affordance snapshot now tracks fifteen circular `?` cues.
