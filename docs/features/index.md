...
- `2026-06-04-real-profile-selected-restore-trust-helper-path-guard.md`: the sacrificial real-profile selected restore trust helper now rejects generated quarantine source paths outside the action `items` root, with a local `-WhatIf` regression.
