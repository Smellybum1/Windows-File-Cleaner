...
- `2026-06-04-accepted-package-complete-notes-selection.md`: accepted-package helpers select latest complete notes by default, now covered by MVP preflight regression.
