...
- A future broader restore/history design still needs to decide whether discovered Restore Manifest entries appear in a separate tab/grid or remain in the manifest discovery/readiness panes.
