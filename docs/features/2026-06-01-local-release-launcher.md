...
- Later packet `Local Release Acceptance Notes Launch Commands` made checklist-only output, generated notes, and notes summary output show exact normal and fixture launch commands without launching WPF.
