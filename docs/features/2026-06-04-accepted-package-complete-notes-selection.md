...
- Added `tools\Test-AcceptedLocalReleaseSelection.cmd` and `.ps1` for clean-runner regression coverage; a follow-up extended it to cover malformed-looking notes.
