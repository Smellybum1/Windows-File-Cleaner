...
- Real Profile Acknowledgement Help Cue added a visible hoverable `?` cue beside the real-profile acknowledgement, mirrors the checkbox tooltip/help text, hides for fixture/custom scopes, and expands WPF smoke affordance coverage to eight cues.
