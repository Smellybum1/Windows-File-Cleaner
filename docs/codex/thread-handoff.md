...
- Branch: `main`
- Latest completed packet: Review Grid Mode Status
...
1. Manual fixture visual polish pass for the collapsible Safety Summary and Quarantine shortlist panels, inline Quarantine Preview readiness, Review Grid Mode Status, plus `Quarantined` / `Back to scan rows` flow.
