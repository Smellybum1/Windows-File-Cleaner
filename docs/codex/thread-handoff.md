...
- Latest tooling/evidence packet: `2026-06-04-mvp-preflight-skip-switch-documentation-regression`
- Latest docs/workflow packet: `2026-06-04-ci-evidence-refresh-after-trust-helper-preflight`
...
- `tools\Test-DocumentationConsistency.cmd` verifies active documentation links, bare active feature-index entries, latest packet breadcrumbs, and that `docs/operations/ci.md` lists every current `Invoke-MvpPreflight.cmd` skip switch; MVP preflight now runs it by default before the whitespace diff check.
