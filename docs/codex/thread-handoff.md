...
- Branch: `main`
- Latest completed packet: Restore Manifest Selection Help Cue
...
- Help Cue Affordance Feature Brief Alignment updated the original hoverable help-cue feature briefs so they no longer stop their later-packet trail at eleven cues; later Restore Manifest Selection Help Cue work moved the current affordance snapshot to sixteen cues.
- Restore Manifest Selection Help Cue added a visible hoverable `?` cue beside the selected-manifest picker, mirrors the picker tooltip/help text, and expands WPF smoke affordance coverage to sixteen cues.
