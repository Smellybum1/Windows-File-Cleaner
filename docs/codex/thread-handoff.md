...
- Branch: `main`
- Latest completed packet: Collapsed Panel Summaries
...
1. Manual fixture visual polish pass for the collapsible Safety Summary and Quarantine shortlist panels plus `Quarantined` / `Back to scan rows` flow.
