...
- Branch: `main`
- Latest completed packet: Quarantine Preview Inline Status
...
1. Manual fixture visual polish pass for the collapsible Safety Summary and Quarantine shortlist panels, inline Quarantine Preview readiness, plus `Quarantined` / `Back to scan rows` flow.
2. Consider light visual severity styling for inline Quarantine Preview readiness only if the next manual pass shows plain text is still too easy to miss.
