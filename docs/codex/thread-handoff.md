...
- Branch: `main`
- Latest completed packet: WPF Real-Profile Restore Readiness Evidence
...
The latest code packet wired read-only Real-Profile Restore Readiness evidence into WPF Selected Restore Execution Gate output and forward Quarantine readiness consumption. WPF now builds restore readiness from selected manifest review, selected restore confirmation draft, and selected restore gate evidence, while still reporting selected-manifest real-profile Undo as unavailable in this build. Real-profile restore and real-profile Quarantine execution remain blocked.
